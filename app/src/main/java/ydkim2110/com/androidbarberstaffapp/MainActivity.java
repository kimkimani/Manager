...
import ydkim2110.com.androidbarberstaffapp.Fragments.ItemShopFragment;
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        ...
                        if (TextUtils.isEmpty(user)) {
                            ...
                            Common.currentHostel = gson.fromJson(Paper.book().read(Common.BARBER_KEY, ""),
                                    new TypeToken<Hostel>(){}.getType());
