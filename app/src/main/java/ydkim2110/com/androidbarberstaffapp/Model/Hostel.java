...
public class Hostel implements Parcelable  {
    ...
    public Hostel(String id, String name, String username, String password, String barberId, Long rating, Long ratingTimes, int slot, Long rent) {
        this.id = id;
        this.name = name;
    ...
    public static Creator<Hostel> getCREATOR() {
        return CREATOR;
    }
