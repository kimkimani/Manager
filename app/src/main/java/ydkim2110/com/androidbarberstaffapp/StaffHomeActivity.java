...
public class StaffHomeActivity extends AppCompatActivity implements ITimeSlotLoadListener, INotificationCountListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if (item.getItemId() == R.id.allhostel) {
            startActivity(new Intent(StaffHomeActivity.this, HostelActivity.class));
    ...
    private void initView() {
        ...
        loadAvailableTimeSlotOfBarber(Common.currentHostel.getBarberId(),
