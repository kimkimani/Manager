...
import ydkim2110.com.androidbarberstaffapp.Model.ShoppingImage;
...
private boolean validateInputs(String name, String price,String image ) {
        if (name.isEmpty()) {
...
//
//        if (!validateInputs(name, price, quantity,image)) {
//
        ...
        if (mImageUri != null) {
          ...
          .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Paper.init(ItemAdd.this);
                            if (!validateInputs(name, price,image)) {
...
//            name password slot username  rent
                                ...
                                ShoppingImage product = new ShoppingImage(
                                        name,
                                        Long.parseLong(price),
                                        image
